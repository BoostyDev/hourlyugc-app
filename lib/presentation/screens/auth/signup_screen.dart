...
/// Signup screen - Diseño igual al Login
...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _handleGoogleSignup() async {
    ...
    // IMPORTANTE: Activar flag ANTES de cualquier operación de auth
    // Esto previene que el router redirija cuando el auth state cambie
  ...
  Future<void> _handleEmailSignup() async {
    ...
    try {
      final result = await ref.read(loginProvider.notifier).registerWithEmail(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Sign up button - IGUAL al de Login
                      GestureDetector(
